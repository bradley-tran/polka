...
func TestBuiltinManifestsLoad(t *testing.T) {
	for _, tool := range []string{PHP, PHPZTS, FrankenPHP, Composer, PIE, NodeJS, Mago, Nginx, Apache, Mailpit, Meilisearch, Redis, PHPMyAdmin, MySQL, MariaDB, PostgreSQL, SQLite} {
